...
export const _appInstalled = ['USA', 'Spain', 'Brazil', 'Italy', 'France', 'Germany', 'Portugal'].map(
  (name, index) => ({
    id: _mock.id(index),
    name,
    totalCustomer: [26, 24, 15, 14, 10, 10, 10][index],
    flag: ['flagpack:us', 'flagpack:es', 'flagpack:br', 'flagpack:it', 'flagpack:fr', 'flagpack:de', 'flagpack:pt'][index],
  })
);
...
export const _appInvoices = [...Array(5)].map((_, index) => {
  const invNo=['SSTL/PI/2024/HO- 2098', 'SSTL/PI/2024/HO- 2028','SSTL/PI/2024/HO- 2098', 'SSTL/PI/2024/HO- 2028','SSTL/PI/2024/HO- 2028', 'SSTL/PI/2024/HO- 1989', 'SSTL/PI/2024/HO- 1989', 'SSTL/PI/2024/HO- 1989', 'SSTL/PI/2024/HO- 2052', 'SSTL/PI/2024/HO- 2052'][index]
  const Colors = ['Raw White', 'Raw White','Raw White', 'Raw White','Raw White', 'Raw White','Raw White', 'Raw White','Raw White', 'Raw Black',][index];
  const StyleNo = ['P687655', 'P767665', 'P9238747', 'P129293', 'P538833'][index];
  const status = ['Done', 'Pending', 'Progress', 'Done', 'Done'][index];
