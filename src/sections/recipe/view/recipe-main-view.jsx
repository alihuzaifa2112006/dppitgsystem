...
import RecipeTableToolbar from '../recipe-toolbar';
import RecipeTableFiltersResult from '../recipe-filters-result';
...
const TABLE_HEAD = [
  { id: 'RecipeAutoNo', label: 'Recipe Auto No', minWidth: 140 },
  { id: 'RecipeName', label: 'Recipe Name', minWidth: 140 },
  ...
  { id: 'RecipePictureURL', label: 'Picture', minWidth:120 },
...
export default function RecipeListView() {
  ...
  const handleDialogOpen = () => {
    navigate(paths.dashboard.rdLab.recipe.new)
  };
  ...
  const moveToEditForm = (e) => {
    ...
    navigate(paths.dashboard.rdLab.recipe.edit(e));
  };
  ...
  if (name) {
    inputData = inputData.filter(
      (yarn) =>
        ...
        yarn?.RecipeName.toLowerCase().indexOf(name.toLowerCase()) !== -1 ||
        yarn?.RecipeAutoNo.toLowerCase().indexOf(name.toLowerCase()) !== -1
    );
  }
