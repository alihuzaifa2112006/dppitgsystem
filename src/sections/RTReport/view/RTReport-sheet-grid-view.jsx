...
import RptDialogTransfer from '../RTExcel';
import { Box } from '@mui/system';
import RTReportGrid from '../RTReport-sheet-grid';
...
export default function RTReportGridView() {
  ...
  const handleSortedTransferReportClick = () => {
    handleDownloadOptionsDialogClose();
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      <CustomBreadcrumbs
        heading="Rag Tearing Production Report (MARGASA)"
        links={[
          {
            name: 'Home',
        ...
        <DialogContent>
          <Stack spacing={2} sx={{ mt: 2 }}>
            ...
            <Button
              ...
              fullWidth
              startIcon={<Iconify icon="uiw:file-excel" />}
              onClick={handleSortedTransferReportClick}
              sx={{ py: 1.5, justifyContent: 'flex-start' }}
            >
              Sorted Transfer Report
            </Button>
            <Button
              variant="outlined"
              fullWidth
