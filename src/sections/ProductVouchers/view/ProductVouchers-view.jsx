...
import ProductVoucherTableRow from '../ProductVouchers-table-row';
import ProductVoucherTableToolbar from '../ProductVouchers-toolbar';
import ProductVoucherTableFiltersResult from '../ProductVouchers-filters-result';
...
export default function ProductVoucherListView() {
 ...
 const flattenRequestData = (requests) => requests.flatMap(request => 
  ...
  const FetchProductVoucherData = useCallback(async () => {
    try {
  ...
  useEffect(() => {
    const fetchData = async () => {
      await Promise.all([FetchProductVoucherData()]);
      setLoading(false);
    };
    fetchData();
  }, [FetchProductVoucherData]);
      ...
      {isLoading ? (
        ...
        <Container maxWidth={settings.themeStretch ? false : 'lg'}>
          ...
          <Card>
            ...
            {canReset && (
              <ProductVoucherTableFiltersResult
                filters={filters}
                onFilters={handleFilters}
