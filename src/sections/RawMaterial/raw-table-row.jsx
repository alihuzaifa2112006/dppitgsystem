...
export default function ProductTableRow({ row, selected, onEditRow, onDeleteRow }) {
  const { RM_Code, Blend_Name, RM_Dimension, RM_OpeningStock, ColorName, UOMName } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{RM_Code}</TableCell>

        {/* <TableCell sx={{ whiteSpace: 'nowrap' }}>{Commercial_Name}</TableCell> */}
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{Blend_Name}</TableCell>

        <TableCell sx={{ whiteSpace: 'wrap' }}>{ColorName}</TableCell>
        {/* <TableCell sx={{ whiteSpace: 'nowrap' }}>{RM_Dimension}</TableCell> */}
        <TableCell sx={{ whiteSpace: 'nowrap', textAlign: 'right' }}>
          {fNumber(RM_OpeningStock)}
        </TableCell>
