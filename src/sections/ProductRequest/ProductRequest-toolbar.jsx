...
export default function ProductRequestTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_ProductRequests.csv');
    ...
    <>
      ...
      >
        <ReactToPrint
          ...
          content={() => tableRef}
          documentTitle="ProductRequest Database"
          pageStyle="print"
        />
      </CustomPopover>
    </>
...
ProductRequestTableToolbar.propTypes = {
