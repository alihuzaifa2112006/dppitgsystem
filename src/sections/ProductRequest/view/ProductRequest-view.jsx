...
import ProductRequestTableRow from '../ProductRequest-table-row';
import ProductRequestTableToolbar from '../ProductRequest-toolbar';
import ProductRequestTableFiltersResult from '../ProductRequest-filters-result';
...
export default function ProductRequestListView() {
 ...
 const flattenRequestData = (requests) => requests.flatMap(request => 
  ...
  useEffect(() => {
    const fetchData = async () => {
      await Promise.all([FetchProductRequestData()]);
      setLoading(false);
    };
    fetchData();
      ...
      {isLoading ? (
        ...
        <Container maxWidth={settings.themeStretch ? false : 'lg'}>
            ...
            action={
              ...
              >
                <Button
                  ...
                  href={paths.dashboard.Production.ProductRequest.new}
                  variant="contained"
          ...
          <Card>
            ...
            {canReset && (
              <ProductRequestTableFiltersResult
                filters={filters}
                onFilters={handleFilters}
