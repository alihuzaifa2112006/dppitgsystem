...
export default function PriceListTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_pricelists.csv');
    ...
    <>
      ...
      >
        <ReactToPrint
          ...
          content={() => tableRef}
          documentTitle='PriceList Database'
          pageStyle='print'
        />
      </CustomPopover>
    </>
...
PriceListTableToolbar.propTypes = {
