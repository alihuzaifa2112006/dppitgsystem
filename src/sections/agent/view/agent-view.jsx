...
import AgentTableToolbar from '../agent-toolbar';
import AgentTableFiltersResult from '../agent-filters-result';
        ...
        <Container maxWidth={settings.themeStretch ? false : 'lg'}>
          <CustomBreadcrumbs
            ...
            links={[
              ...
              { name: 'Agency', href: paths.dashboard.customer.agent.root },
              { name: 'list' },
            ]}
            action={
              <Box
