...
export default function SparePartsTableRow({ row, selected, onEditRow, onDeleteRow }) {
  const { IsActive, SpareName, SpareNo, SpareNameAndNo } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell>{SpareNo}</TableCell>
        <TableCell>{SpareName}</TableCell>
        <TableCell>{SpareNameAndNo}</TableCell>
