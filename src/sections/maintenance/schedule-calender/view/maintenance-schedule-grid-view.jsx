...
import MaintenanceScheduleGrid from '../maintenance-schedule-grid';
import { Box } from '@mui/system';
// import RptDialog from '../ReportDialog';

// ----------------------------------------------------------------------

export default function MaintenanceScheduleGridView() {
        ...
        action={
          ...
          >
            ...
            <Button
              ...
              href={paths.dashboard.Production.maintenance.schedule.new}
              variant="contained"
