...
// import MCheckListReportTableRow from '../MCheckListReport-table-row';
// import MCheckListReportTableToolbar from '../MCheckListReport-toolbar';
// import MCheckListReportTableFiltersResult from '../MCheckListReport-filters-result';
...
// export default function MCheckListReportListView() {
...
//   const FetchMCheckListReportData = useCallback(async () => {
//     try {
...
//     } catch (error) {
//       console.error(error);
//       enqueueSnackbar('Error fetching MCheckList reports', { variant: 'error' });
//     }
...
//       await FetchMCheckListReportData();
//       setLoading(false);
//     };
//     fetchData();
//   }, [FetchMCheckListReportData]);
...
//               {
//                 name: 'MCheckList',
//                 href: paths.dashboard.MCheckList.MCheckListReport.root,
//               },
...
//                 href={paths.dashboard.MCheckList.MCheckListReport.new}
//                 variant="contained"
...
//             {canReset && (
//               <MCheckListReportTableFiltersResult
//                 filters={filters}
//                 onFilters={handleFilters}
