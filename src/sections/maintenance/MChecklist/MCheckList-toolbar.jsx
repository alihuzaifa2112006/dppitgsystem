...
export default function MCheckListReportTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_MCheckListReports.csv');
    ...
    <>
            ...
            InputProps={{
              startAdornment: (
                <InputAdornment position="start">
                  <Iconify icon="eva:search-fill" sx={{ MCheckListReport: 'text.disabled' }} />
                </InputAdornment>
              ),
            }}
          />
      ...
      >
        <ReactToPrint
          ...
          content={() => tableRef}
          documentTitle="MCheckListReport Database"
          pageStyle="print"
        />
      </CustomPopover>
    </>
...
MCheckListReportTableToolbar.propTypes = {
