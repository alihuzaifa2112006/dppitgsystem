...
export default function LocationTableRow({ row, selected, onEditRow, onDeleteRow }) {
  const { Unit_Location_name, isActive, City_Name, Country_Name } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell >{Unit_Location_name}</TableCell>
