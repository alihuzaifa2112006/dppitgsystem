...
import PIRegisterEditForm from '../PIRegister-edit';
import { useEffect, useMemo, useState } from 'react';
import { Get } from 'src/api/apibasemethods';

// ----------------------------------------------------------------------

export default function PIRegisterEditView({ urlData }) {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      ...
      {currentData && <PIRegisterEditForm currentData={currentData} />}
    </Container>
  );
}

PIRegisterEditView.propTypes = {
