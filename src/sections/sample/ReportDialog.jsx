  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.get(
        `${APP_API}ExportSampleRequestsExcel?OrgID=${userData?.userDetails?.orgId}&BranchID=${userData?.userDetails?.branchID}&SampleRequestDateFrom=${formattedStart}&SampleRequestDateTo=${formattedEnd}&KAM=${Kam}`,
        { responseType: 'blob' }
      );
      ...
      link.href = blobUrl;
      link.download = 'SampleExcelReport.xlsx';
