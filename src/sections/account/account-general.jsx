...
export default function AccountGeneral() {
  ...
  const defaultValues = useMemo(
    () => ({
      UserName: userData ? userData?.userDetails?.firstName : '',
      EmailAddress: userData ? userData?.userDetails?.emailAddress : '',
      ImagePath: userData ? userData?.userDetails?.ImagePath : null,
      Designation: userData ? userData?.userDetails?.designation : '',
    }),
    [userData]
  );
