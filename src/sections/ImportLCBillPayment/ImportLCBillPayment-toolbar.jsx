...
export default function ImportLCBillPaymentTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'import_lc_information.csv');
    ...
    <>
      ...
      >
        <ReactToPrint
          ...
          content={() => tableRef}
            documentTitle='Import LC Information'
          pageStyle='print'
        />
      </CustomPopover>
    </>
...
ImportLCBillPaymentTableToolbar.propTypes = {
