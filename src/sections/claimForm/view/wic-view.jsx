...
import ComplaintPageLinkDialog from '../complaint-page-link-dialog';
...
export default function WICListView() {
  ...
  const handleGenerateLink = (id) => {
    const encryptedWIC_ID = encrypt(id);
    const encodedWIC_ID = encodeURIComponent(encryptedWIC_ID);
    const protocol = window.location.protocol;
    const hostname = window.location.hostname;
    setDynamicURL(`${protocol}//${hostname}/complaint-registration-form/${encodedWIC_ID}`);
        ...
        <Container maxWidth={settings.themeStretch ? false : 'lg'}>
          <CustomBreadcrumbs
            ...
            links={[
              ...
              { name: 'Claim Form', href: paths.dashboard.customerClaim.claimForm },
              { name: 'List' },
            ]}
            // action={
              ...
              <Scrollbar>
                ...
                >
                  ...
                  <TableBody>
                    {dataFiltered
                      ...
                      .map((row) => (
                        <WICTableRow
                          ...
                          onLinkClick={() => handleGenerateLink(row?.WIC_ID)}
                    ...
                    <ComplaintPageLinkDialog
                      openLink={linkDialogOpen}
                      onCloseLink={handleLinkDialogClose}
                      Link={dynamicURL}
                    />
