...
export default function TransferVoucherTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_TransferVouchers.csv');
    ...
    <>
            ...
            InputProps={{
              startAdornment: (
                <InputAdornment position="start">
                  <Iconify icon="eva:search-fill" sx={{ TransferVoucher: 'text.disabled' }} />
                </InputAdornment>
              ),
            }}
          />
      ...
      >
        <ReactToPrint
          ...
          content={() => tableRef}
          documentTitle="TransferVoucher Database"
          pageStyle="print"
        />
      </CustomPopover>
    </>
...
TransferVoucherTableToolbar.propTypes = {
