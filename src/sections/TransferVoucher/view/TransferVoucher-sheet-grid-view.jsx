...
import PrRequestGrid from '../TransferVoucher-sheet-grid';


// ----------------------------------------------------------------------

export default function TransferVoucherGridView() {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      <CustomBreadcrumbs
        heading="Transfer Vouchers List"
        links={[
          {
            name: 'Home',
            href: paths.dashboard.root,
          },
          { name: 'Waste Voucher List' },
        ]}
        sx={{
          mb: { xs: 3, md: 5 },
        }}
