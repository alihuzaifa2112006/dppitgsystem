...
export default function DrawReportTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_DrawReports.csv');
    ...
    <>
            ...
            InputProps={{
              startAdornment: (
                <InputAdornment position="start">
                  <Iconify icon="eva:search-fill" sx={{ DrawReport: 'text.disabled' }} />
                </InputAdornment>
              ),
            }}
          />
      ...
      >
        <ReactToPrint
          ...
          content={() => tableRef}
          documentTitle="DrawReport Database"
          pageStyle="print"
        />
      </CustomPopover>
    </>
...
DrawReportTableToolbar.propTypes = {
