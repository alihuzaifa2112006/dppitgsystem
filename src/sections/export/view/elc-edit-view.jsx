...
import ExportEditForm from '../elc-edit';
...
export default function ExportEditView({ urlData }) {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      ...
      <ExportEditForm currentData={currentData} clauses={clauses} />
    </Container>
  );
}

ExportEditView.propTypes = {
