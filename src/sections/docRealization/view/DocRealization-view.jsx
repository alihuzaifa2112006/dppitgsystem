...
import DocRealizationEdit from '../DocRealization-edit';

// --------------------------------------------------------

export default function DocRealizationView({ urlData }) {
  ...
  return (
    <Container container={settings.themeStretch ? false : 'lg'}>
      ...
      {isLoading ? (
        ...
        <DocRealizationEdit currentData={currentData} />
      )}
    </Container>
  );
}

DocRealizationView.propTypes = {
