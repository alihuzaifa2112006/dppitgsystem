...
import ItemRequisitionApprovalForm from '../ItemRequisition-approval';
import { useEffect, useState } from 'react';
import { Get } from 'src/api/apibasemethods';

// ----------------------------------------------------------------------

export default function ItemRequisitionApprovalView({ urlData }) {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      <CustomBreadcrumbs
        heading="Approval of ItemRequisition"
        links={[
          {
            name: 'Home',
      ...
      {currentData && <ItemRequisitionApprovalForm currentData={currentData} />}
    </Container>
  );
}

ItemRequisitionApprovalView.propTypes = {
