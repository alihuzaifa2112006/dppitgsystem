...
export default function ProductionMiddlewareApprovalForm({ currentData }) {
  ...
  const SendApproval = async (yesORno) => {
    ...
    try {
      ...
      if (respones?.status === 200) {
        ...
        const generatedLink = `${APP_URL}${paths.dashboard.Production.Planning.ProductionMiddleware.approval(
...
ProductionMiddlewareApprovalForm.propTypes = {
