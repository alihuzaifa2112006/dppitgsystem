...
import DispoderEditForm from '../ProductionMiddleware-edit';
import { formatDate } from '@fullcalendar/core';

// ----------------------------------------------------------------------

export default function ProductionMiddlewareEditView({ urlData }) {
  const settings = useSettingsContext();
  const userData = useMemo(() => JSON.parse(localStorage.getItem('UserData')), []);

  const [currentData, setCurrentData] = useState(null);

  const idFromURL = urlData?.ProductionMiddlewareID;
...
ProductionMiddlewareEditView.propTypes = {
