...
export default function ItemOpenApprovalForm({ currentData }) {
  ...
  const SendApproval = async (yesORno) => {
    ...
    try {
      ...
      if (respones?.status === 200) {
        ...
        const generatedLink = `${APP_URL}${paths.dashboard.InventoryManagement.ItemOpen.approval(
...
ItemOpenApprovalForm.propTypes = {
