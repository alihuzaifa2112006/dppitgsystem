...
export default function DispoderApprovalForm({ currentData }) {
  ...
  const SendApproval = async (yesORno) => {
    ...
    try {
      ...
      if (respones?.status === 200) {
        ...
        const generatedLink = `${APP_URL}${paths.dashboard.customerClaim.dispoder.approval(
...
DispoderApprovalForm.propTypes = {
