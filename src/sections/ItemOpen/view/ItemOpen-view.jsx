...
import ItemOpenTableRow from '../ItemOpen-table-row';
import ItemOpenTableToolbar from '../ItemOpen-toolbar';
import ItemOpenTableFiltersResult from '../ItemOpen-filters-result';
        ...
        <Container maxWidth={settings.themeStretch ? false : 'lg'}>
          <CustomBreadcrumbs
            ...
            links={[
              ...
              { name: 'Item Entry', href: paths.dashboard.InventoryManagement.ItemOpen.root },
              { name: 'List' },
            ]}
            action={
              <Button
