...
import ImportInvoiceEntryEditForm from '../ImportInvoiceEntry-edit';
import { useEffect, useMemo, useState } from 'react';
import { Get } from 'src/api/apibasemethods';

// ----------------------------------------------------------------------

export default function ImportInvoiceEntryEditView({ urlData }) {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      <CustomBreadcrumbs
        heading="Edit Import Invoice Entry"
        links={[
          {
            name: 'Home',
      ...
      {currentData && <ImportInvoiceEntryEditForm currentData={currentData} />}
    </Container>
  );
}

ImportInvoiceEntryEditView.propTypes = {
