...
export default function PreOnboardingTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_preonboardings.csv');
    ...
    <>
      ...
      >
        <ReactToPrint
          ...
          content={() => tableRef}
          documentTitle="PreOnboarding Database"
          pageStyle="print"
        />
      </CustomPopover>
    </>
...
PreOnboardingTableToolbar.propTypes = {
