...
import AgencyTableToolbar from '../agency-toolbar';
import AgencyTableFiltersResult from '../agency-filters-result';
...
const TABLE_HEAD = [
  { id: 'Agent_Name', label: 'Agency Name', minWidth: 140 },
...
export default function AgencyListView() {
  ...
  const handleDialogOpen = () => {
    navigate(paths.dashboard.customer.agency.new)
  };
  ...
  const moveToEditForm = (e) => {
    ...
    navigate(paths.dashboard.customer.agency.edit(e));
  };
...
function applyFilter({ inputData, comparator, filters }) {
  ...
  if (name) {
    inputData = inputData.filter(
      (yarn) =>
        yarn?.Agent_Name.toLowerCase().indexOf(name.toLowerCase()) !== -1 ||
