...
export default function LedgerDialog({ uploadClose, uploadOpen }) {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.get(
        `${APP_API}ExportStockMovementReport?OrgID=${
          userData?.userDetails?.orgId
        }&BranchId=${userData?.userDetails?.branchID}&fromDate=${formattedStart || null}&toDate=${
          formattedEnd || null
        }`,
        { responseType: 'blob' }
      );
      ...
      link.href = blobUrl;
      link.download = 'StockMovementLedgerReport.xlsx';
