...
export default function INVCategoryTableRow({ row, selected, onEditRow, onDeleteRow }) {
  const { Inv_Cat_Name, Symbol, Code, ClassName } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        {/* <TableCell >{Material_Type}</TableCell> */}
