...
export default function INVCATEGORYTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_categorys.csv');
    ...
    <>
      ...
      >
        <ReactToPrint
          ...
          content={() => tableRef}
          documentTitle="INVCATEGORY Database"
          pageStyle="print"
        />
      </CustomPopover>
    </>
...
INVCATEGORYTableToolbar.propTypes = {
