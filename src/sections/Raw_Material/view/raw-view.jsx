...
const TABLE_HEAD = [
  ...
  { id: ' RM_OpeningStock', label: 'Quantity', minWidth: 120 },
...
export default function RMListView() {
  ...
  const FetchProductData = useCallback(async () => {
    try {
      const response = await Get(
        `GetRawMaterials?orgId=${userData?.userDetails?.orgId}&branchId=${userData?.userDetails?.branchID}`
      );
