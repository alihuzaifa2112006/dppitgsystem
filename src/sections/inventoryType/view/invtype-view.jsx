...
import InvTypeTableToolbar from '../invtype-toolbar';
...
const TABLE_HEAD = [
  { id: 'SubCat_Name', label: 'Sub Category', minWidth: 140 },
  { id: 'Inv_Cat_Name', label: 'Category  ', minWidth: 140 },
  { id: 'ClassName', label: 'Class', minWidth: 140 },
  { id: 'Code', label: 'Code', align: 'center', minWidth: 140 },
        ...
        <Container maxWidth={settings.themeStretch ? false : 'lg'}>
          <CustomBreadcrumbs
            ...
            links={[
              ...
              { name: 'Sub Category ', href: paths.dashboard.admin.subcategory.root },
              { name: 'list' },
            ]}
            action={
              <Box
...
function applyFilter({ inputData, comparator, filters }) {
  ...
  if (name) {
    inputData = inputData.filter(
      (yarn) =>
        yarn?.SubCat_Name.toLowerCase().indexOf(name.toLowerCase()) !== -1 ||
