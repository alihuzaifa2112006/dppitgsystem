...
import ColorWiseStockReportGrid from '../ColorWiseStockReport-sheet-grid';
...
export default function ColorWiseStockReportGridView() {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        ...
        action={
          ...
          >
            ...
            {/* <Button
              ...
              href={paths.dashboard.reports.colorwisestockreport.new}
              variant="contained"
      ...
      <ColorWiseStockReportGrid superSearch={isSuperSearchEnabled} />
