  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.get(
        `${APP_API}exportItemColorWiseStockReport?Org_Id=${userData?.userDetails?.orgId
        }&Branch_Id=${userData?.userDetails?.branchID}&fromDate=${formattedStart || null}&toDate=${formattedEnd || null
        }`,
        { responseType: 'blob' }
      );
      // Verify the Blob
      ...
      link.href = blobUrl;
      link.download = 'ItemColorWiseStockReport.xlsx';
