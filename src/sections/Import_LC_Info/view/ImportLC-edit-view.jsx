...
import ImportLCEditForm from '../ImportLC-edit';
import { useEffect, useMemo, useState } from 'react';
import { Get } from 'src/api/apibasemethods';

// ----------------------------------------------------------------------

export default function ImportLCEditView({ urlData }) {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      <CustomBreadcrumbs
        heading="Edit Import LC Information"
        links={[
          {
            name: 'Home',
      ...
      {currentData && <ImportLCEditForm currentData={currentData} />}
    </Container>
  );
}

ImportLCEditView.propTypes = {
