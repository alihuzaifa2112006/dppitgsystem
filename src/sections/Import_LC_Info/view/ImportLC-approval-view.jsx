...
// import ImportLCApprovalForm from '../ImportLC-approval';

// ----------------------------------------------------------------------

export default function ImportLCApprovalView({ urlData }) {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      <CustomBreadcrumbs
        heading="Approval of Import LC Information"
        links={[
          {
            name: 'Home',
          ...
          },
          {
            ...
            href: paths.dashboard.Commercial.ImportLC.root,
          },
          { name: 'Approval' },
        ]}
        sx={{
      ...
      {/* {currentData && <ImportLCApprovalForm currentData={currentData} />} */}
    </Container>
  );
}

ImportLCApprovalView.propTypes = {
