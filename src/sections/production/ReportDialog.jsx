  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.get(
        `${APP_API}ExportMRP?OrgId=${
          userData?.userDetails?.orgId
        }&BranchId=${userData?.userDetails?.branchID}&fromMonth=${fDate(
          startDate,
          'yyyy-MM'
        )}&toMonth=${fDate(endDate, 'yyyy-MM')}`,
        { responseType: 'blob' }
      );
      // Verify the Blob
      ...
      link.href = blobUrl;
      link.download = 'ProductionMRPReport.xlsx';
