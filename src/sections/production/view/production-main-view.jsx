...
import ProductionTableToolbar from '../production-toolbar';
import ProductionTableFiltersResult from '../production-filters-result';
...
const TABLE_HEAD = [
  ...
  { id: 'ColorNameandCode', label: 'Color Code', minWidth: 140 },
...
export default function ProductionListView() {
  ...
  const handleDialogOpen = () => {
    navigate(paths.dashboard.Production.Planning.production.new);
  };
  ...
  const moveToEditForm = (e) => {
    ...
    navigate(paths.dashboard.Production.Planning.production.edit(e));
  };
        ...
        <Container maxWidth={settings.themeStretch ? false : 'lg'}>
          <CustomBreadcrumbs
            ...
            links={[
              ...
              { name: 'Production', href: paths.dashboard.Production.Planning.production.root },
              { name: 'list' },
            ]}
            action={
              <Box
