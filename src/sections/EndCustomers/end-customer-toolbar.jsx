...
export default function EndCustomerTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_main_buyers.csv');
    ...
    <>
      ...
      >
        <ReactToPrint
          trigger={() => (
            <>
              ...
              <a
                ...
                href={`${APP_API}export/end-customers`}
                download="All_MainBuyers.xlsx"
              >
                <MenuItem
                  onClick={() => {
                    // handleExportCSV();
          ...
          content={() => tableRef}
          documentTitle="EndCustomer Database"
          pageStyle="print"
        />
      </CustomPopover>
    </>
...
EndCustomerTableToolbar.propTypes = {
