...
export default function WICInviteTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_customer_onboards.csv');
    ...
    <>
      ...
      >
        <ReactToPrint
          ...
          content={() => tableRef}
          documentTitle='WIC Invite Database'
          pageStyle='print'
        />
      </CustomPopover>
    </>
...
WICInviteTableToolbar.propTypes = {
