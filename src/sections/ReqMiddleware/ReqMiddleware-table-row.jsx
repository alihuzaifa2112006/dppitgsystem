...
export default function InvTypeTableRow({ row, selected, onEditRow, onDeleteRow }) {
  const { SubCat_Name, Inv_Cat_Name, ClassName, RequestedBy, DepartmentName, SectionName } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        {/* <TableCell sx={{textAlign:'center'}}> <Label   color={getStatusColor(Is_Active)}>{Is_Active}</Label></TableCell> */}
