...
export default function StaffCategoryTableRow({ row, selected, onEditRow, onDeleteRow }) {
  const { Category_Name, isActive, City_Name, Country_Name } = row;
...
StaffCategoryTableRow.propTypes = {
