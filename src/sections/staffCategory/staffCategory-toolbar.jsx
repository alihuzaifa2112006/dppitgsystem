...
export default function StaffCategoryTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_staff_categories.csv');
    ...
    <>
      ...
      >
        <ReactToPrint
          ...
          content={() => tableRef}
          documentTitle="Staff Category Database"
          pageStyle="print"
        />
      </CustomPopover>
    </>
...
StaffCategoryTableToolbar.propTypes = {
