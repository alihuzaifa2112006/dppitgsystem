...
export default function GoodsRecievedConfirmationTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_GoodsRecievedConfirmations.csv');
    ...
    <>
      ...
      >
        <ReactToPrint
          ...
          content={() => tableRef}
          documentTitle="Goods Recieved Confirmation Database"
          pageStyle="print"
        />
      </CustomPopover>
    </>
...
GoodsRecievedConfirmationTableToolbar.propTypes = {
