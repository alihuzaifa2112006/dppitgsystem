...
export default function WasteVoucherTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_WasteVouchers.csv');
    ...
    <>
            ...
            InputProps={{
              startAdornment: (
                <InputAdornment position="start">
                  <Iconify icon="eva:search-fill" sx={{ WasteVoucher: 'text.disabled' }} />
                </InputAdornment>
              ),
            }}
          />
      ...
      >
        <ReactToPrint
          ...
          content={() => tableRef}
          documentTitle="WasteVoucher Database"
          pageStyle="print"
        />
      </CustomPopover>
    </>
...
WasteVoucherTableToolbar.propTypes = {
