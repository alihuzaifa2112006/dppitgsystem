...
export default function WICTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_wic.csv');
          ...
          trigger={() => (
            <>
              ...
              <a
                ...
                href={`${APP_API}export/walkin-customers`}
                download="All_WIC.xlsx"
              >
                <MenuItem
                  onClick={() => {
                    // handleExportCSV();
