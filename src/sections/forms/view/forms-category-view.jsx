...
import FormsTableRow from '../forms-category-table-row';
import FormsTableToolbar from '../forms-category-toolbar';
import FormsTableFiltersResult from '../forms-category-filters-result';
...
const TABLE_HEAD = [
  { id: 'FormName', label: 'Name', minWidth: 140 },
...
const FetchProfileData = useCallback(async () => {
  try {
    ...
    setTableData(response.data.Data); // or setTableData(filteredData) if filtered
  } catch (error) {
    console.log('Error fetching Forms profiles:', error);
  }
}, []);
console.log(tableData,'table')
  ...
  const moveToEditForm = (e) => {
    navigate(paths.dashboard.admin.forms.edit(e));
  };
      ...
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: 'Forms', href: paths.dashboard.admin.forms.root },
            { name: 'List' },
          ]}
          action={
           <Box
           ...
           >
             ...
             <Button
              ...
              href={paths.dashboard.admin.forms.new}
              variant="contained"
                    ...
                    {dataFiltered
                      ...
                      .map((row) => (
                        <FormsTableRow
                          ...
                          onEditRow={() => moveToEditForm(row?.FormID)}
                        />
                      ))}
...
function applyFilter({ inputData, comparator, filters }) {
  ...
  if (name) {
    inputData = inputData.filter(
      (yarn) =>
         yarn?.FormName.toLowerCase().indexOf(name.toLowerCase()) !== -1
