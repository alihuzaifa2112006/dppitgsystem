...
export default function ItemOpenDatabaseApprovalForm({ currentData }) {
  ...
  const SendApproval = async (yesORno) => {
    ...
    try {
      ...
      if (respones?.status === 200) {
        ...
        const generatedLink = `${APP_URL}${paths.dashboard.InventoryManagement.ItemOpenDatabase.approval(
...
ItemOpenDatabaseApprovalForm.propTypes = {
