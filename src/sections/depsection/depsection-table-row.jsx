...
export default function DepsectionTableRow({ row, selected, onEditRow, onDeleteRow }) {
  const { SectionName, isActive, Description, DPT_Name } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{SectionName}</TableCell>

        <TableCell sx={{ whiteSpace: 'nowrap' }}>{DPT_Name}</TableCell>
