...
export default function YarnTypeTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_yarn_types.csv');
    ...
    <>
      ...
      >
        <ReactToPrint
          ...
          content={() => tableRef}
          documentTitle='YarnType Database'
          pageStyle='print'
        />
      </CustomPopover>
    </>
...
YarnTypeTableToolbar.propTypes = {
