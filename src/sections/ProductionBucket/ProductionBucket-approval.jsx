...
export default function ProductionBucketApprovalForm({ currentData }) {
  ...
  const SendApproval = async (yesORno) => {
    ...
    try {
      ...
      if (respones?.status === 200) {
        ...
        const generatedLink = `${APP_URL}${paths.dashboard.Production.Planning.ProductionBucket.approval(
...
ProductionBucketApprovalForm.propTypes = {
