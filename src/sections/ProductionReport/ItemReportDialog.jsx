    ...
    try {
      ...
      const response = await axios.get(
        `${APP_API}ExportProductionReport?OrgId=${
          ...
          startDate,
          'yyyy-MM-dd'
        )}&toDate=${fDate(endDate, 'yyyy-MM-dd')}&DeptID=9&SectionID=26`,
        { responseType: 'blob' }
      );
      // Verify the Blob
      ...
      link.href = blobUrl;
      link.download = `SortingItemProductionReport_${fDate(startDate, 'dd-MM-yyyy')}_to_${fDate(endDate, 'dd-MM-yyyy')}${new Date().getTime()}.xlsx`;
