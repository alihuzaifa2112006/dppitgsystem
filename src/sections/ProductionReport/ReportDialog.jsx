...
export default function RptDialog({ uploadClose, uploadOpen }) {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      link.href = blobUrl;
      link.download = `SortingProductionReport_${fDate(startDate, 'dd-MM-yyyy')}_to_${fDate(endDate, 'dd-MM-yyyy')}${new Date().getTime()}.xlsx`;
