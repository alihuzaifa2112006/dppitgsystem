...
export default function AssignEditForm({ currentData }) {
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    if (currentData?.Level1_Approved_ID || currentData?.Level2_Approved_ID) {
      enqueueSnackbar('This Assign is already approved, you cannot edit it.', {
        variant: 'error',
      });
      return;
    }
  ...
  const handleEditDetail = (index) => {
    ...
    setValue('Requirement', detail.Requirement);
  ...
  // Table Heads
  const DetailsTableHead = currentData
    ? [
