...
import AssignApprovalForm from '../assign-approval';
import { useEffect, useState } from 'react';
import { Get } from 'src/api/apibasemethods';

// ----------------------------------------------------------------------

export default function AssignApprovalView({ urlData }) {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      ...
      {currentData && <AssignApprovalForm currentData={currentData} />}
    </Container>
  );
}

AssignApprovalView.propTypes = {
