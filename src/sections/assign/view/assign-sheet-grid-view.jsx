...
import AssignGrid from '../assign-sheet-grid';

// ----------------------------------------------------------------------

export default function AssignGridView() {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      <CustomBreadcrumbs
        ...
        action={
          <Button
            ...
            href={paths.dashboard.transaction.Assign.new}
            variant="contained"
      ...
      <AssignGrid superSearch={isSuperSearchEnabled} />
    </Container>
  );
}
