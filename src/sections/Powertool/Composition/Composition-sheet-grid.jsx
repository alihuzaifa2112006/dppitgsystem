...
export default function CompositionSheetGrid() {
  ...
  const handleEdit = (id) => {
    navigate(paths.dashboard.Powertool.Composition.edit(id));
  };
            ...
            <TableBody>
              {paginatedData.length > 0 ? (
                paginatedData.map((row, index) => (
                  <TableRow hover key={row.CompositionId || index}>
                    <TableCell>{row.CompositionId}</TableCell>
                    ...
                    <TableCell align="center">
                      <Tooltip title="Edit">
                        <IconButton size="small" onClick={() => handleEdit(row.CompositionId)} sx={{ color: 'primary.main' }}>
                          <Iconify icon="solar:pen-bold" />
                        </IconButton>
                      </Tooltip>
                      <Tooltip title="Delete">
                        <IconButton size="small" onClick={() => setDeleteId(row.CompositionId)} sx={{ color: 'error.main' }}>
                ...
                <TableRow>
                  <TableCell colSpan={4} align="center" sx={{ py: 5 }}>
                    <Typography variant="body2" color="text.secondary">No Composition found.</Typography>
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
