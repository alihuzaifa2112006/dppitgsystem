...
export default function BlendnameTableToolbar({
  filters,
  onFilters,
  //
  roleOptions,
  ...
  const handleExportCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'cyclo_blendnames.csv');
  ...
  return (
    <>
      ...
      >
        ...
        >
          <InputLabel>Blend Type</InputLabel>

          <Select
            multiple
            value={filters.role}
            onChange={handleFilterRole}
            input={<OutlinedInput label="Blend Type" />}
      ...
      >
        <ReactToPrint
          ...
          content={() => tableRef}
          documentTitle="Blendname Database"
          pageStyle="print"
        />
      </CustomPopover>
    </>
...
BlendnameTableToolbar.propTypes = {
