...
export default function Blend_NamesTableRow({ row, selected, onEditRow, onDeleteRow }) {
  const { Blend_Names, isActive, Blend_Type_Name, Country_Name } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        {/* <TableCell sx={{ whiteSpace: 'nowrap' }}>{Blend_Type_Name}</TableCell> */}
        ...
        <TableCell sx={{ whiteSpace: 'nowrap', textAlign: 'center' }}>
          <Label color={getStatusColor(Blend_Type_Name)}>{Blend_Type_Name}</Label>
        </TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap', textAlign: 'center' }}>
